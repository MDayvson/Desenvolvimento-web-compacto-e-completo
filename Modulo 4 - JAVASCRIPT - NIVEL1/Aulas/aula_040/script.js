...
document.querySelector("#btn_vermelho").addEventListener("click", (e) => {
    delete_elements()
...
document.querySelector("#btn_verde").addEventListener("click", (e) => {
    delete_elements()
    for(let i=0; i<=250; i+=10){
        let tmp = document.createElement("div")
        tmp.classList.add("caixa")
...
document.querySelector("#btn_azul").addEventListener("click", (e) => {
    delete_elements()
    for(let i=0; i<=250; i+=10){
        let tmp = document.createElement("div")
        tmp.classList.add("caixa")
